    ...
    <v-container fluid>
      <v-row>
        <v-col cols="12">
              ...
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
                    ...
                    <v-text-field label="Search your daily groceries"
                      class="d-none d-sm-none d-md-flex"
                      filled solo prepend-inner-icon="mdi-magnify" flat  rounded outlined success
                    ></v-text-field>
          ...
          <PartnerSec />
          <v-card flat color="#E2F2E5" class="rounded-xl mtop mbottom mx-10 pa-4" height="550">
            <v-row>
              <v-col cols="12" xs="12" sm="12" md="5">
                <v-card class="rounded-xl mt-16 ml-16 mobile" outlined flat height="450" width="200">
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.<br /> 
                  Fugiat incidunt maxime quam ab rem, laudantium nam<br />
                  quisquam sint iusto perferendis expedita nulla laborum quis<br />
                  alias tenetur amet nesciunt sed corrupti.
                  </p>
...
import PackSec from "../components/PackSec";
